        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("emailsettings/update/$item->id"); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label>Email Host Bilgisi</label>
                    ...
                    <div class="form-group">
                        <label>E-Mail Adresine Ait Şifre</label>
                    ...
                    <div class="form-group">
                        <label>E-Mail Başlık</label>
                        <input class="form-control" type="text" placeholder="E-mail Başlık" name="user_name" value="<?php echo isset($form_error) ? set_value("user_name") : $item->user_name; ?> ">
                        <?php if (isset($form_error)) { ?>
