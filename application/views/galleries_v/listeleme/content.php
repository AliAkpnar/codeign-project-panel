                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    if ($item->gallery_type == "image") {
                                        ...
                                        $button_icon = "fa-eye";
                                        $button_url = "galleries/g_video_list/$item->id";
                                    ...
                                    <a href="<?php echo base_url($button_url); ?>" class="btn btn-sm btn-dark btn-outline"><i class="fa <?php echo $button_icon ?> "></i> Galeri</a>
                                </td>
                            </tr>
