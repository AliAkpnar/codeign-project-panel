		...
		<tbody class="sortable" data-url="<?php echo base_url("product/imageRankSetter"); ?>">
			<?php foreach ($item_images as $image) { ?>
				...
				<tr id="ord-<?php echo $image->id; ?>">
					<!-- liste sıralaması reorder -->
					<td class="w100 text-center"><i class="fa fa-reorder"></i></td>
					...
					<td class="w100 text-center">
						<input data-url="<?php echo base_url("product/imageIsActiveSetter/$image->id"); ?>" class="isActive" type="checkbox" data-switchery data-size="" data-color="#ADFF2F" <?php echo ($image->isActive) ? "checked" : ""; ?> />
					</td>
					<td class="w100 text-center">
					...
					<td class="w100 text-center">
						<button data-url="<?php echo base_url("product/image_delete/$image->id/$image->product_id"); ?>" class="btn btn-sm btn-danger btn-outline remove-btn btn-block">
