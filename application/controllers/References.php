    ...
    public function update($id)
    {
        ...
        if ($validate) {
            ...
            if ($_FILES["img_url"]["name"] !== "") {
                ...
                $dosya_adi = convertToSEO(pathinfo($_FILES["img_url"]["name"], PATHINFO_FILENAME)) . "." . pathinfo($_FILES["img_url"]["name"], PATHINFO_EXTENSION);
                ...
                if ($upload) {
                    ...
                    $uploaded_file = $this->upload->data("dosya_adi");
